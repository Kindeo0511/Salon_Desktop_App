...
INSERT INTO `tbl_discount` (`discount_id`, `discount_type`, `promo_code`, `discount_rate`, `expiry_date`, `status`, `max_usage`, `per_customer_limit`, `notif_on_create`, `notif_on_expired`, `is_deleted`) VALUES
...
(8, 19, '2025-10-03', '02:02:33', '02:02:33', 0, '', 0);
...
(6, 'kindeo', 'asdasdsad', 'test@gmail.com', '3123213321', 'Active', 0),
...
--
ALTER TABLE `tbl_appointment`
  MODIFY `appointment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=837;
...
--
ALTER TABLE `tbl_delivery_items`
  MODIFY `delivery_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `tbl_servicesname`
  MODIFY `serviceName_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
--
ALTER TABLE `tbl_subcategory`
  MODIFY `subCategory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
