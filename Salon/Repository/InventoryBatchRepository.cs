...
namespace Salon.Repository
{
    public class InventoryBatchRepository : I_InventoryBatches
    {
        ...
        public IEnumerable<InventoryBatchModel> GetAllInventoryBatch()
        {
            ...
            {
                var sql = @"SELECT i_b.batch_id, d.delivery_item_id, p.product_id, p.product_name, i_b.unit,i_b.volume_per_unit, i_b.volume, i_b.price, i_b.notes, i_b.delivered_date, i_b.expiry_date
