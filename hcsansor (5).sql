...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2025 at 09:05 AM
...
(779, 51, NULL, '2025-10-02 00:00:00', '', '10:00:00', '00:00:00', 'Scheduled', 'Unpaid', 'Phone Call', 'None');
...
(77, 'a', 'Service', 'Active', 0),
(78, 'asd', 'Service', 'Active', 0);
...
(48, 'test', 'test', 'test', 'test', 'test', 'Male', '', '', '', '', NULL, NULL, NULL, 0),
...
INSERT INTO `tbl_discount` (`discount_id`, `discount_type`, `promo_code`, `discount_rate`) VALUES
(1, 'Senior/PWD', NULL, 20),
(6, 'Promo', '123', 15);
...
(7, 20, '2025-09-30', '10:18:23', '10:18:23', 1, 'test'),
...
(2, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:43'),
(3, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:44'),
(4, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:44'),
(5, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:45'),
(6, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:45'),
(7, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:46'),
(8, 'Utilities', 'Monthly Rent & Bills', 12444, 'admin', '', '2025-10-03 11:07:46');
...
INSERT INTO `tbl_overhead` (`over_head_id`, `monthly_rent`, `utilities_amount`, `total_over_head`, `total_working_hours`) VALUES
(2, 10000, 2444, 12444, 224);
...
(20, 'Mohaifa ', 'Lakiman', 'Malik', '2000-06-22', 'malikmohaifagmail.com', '', '', 'Blk - 31 Lot - 19 Lanao Del Norte Maharlik Vill. Taguig City', '', 600, 0),
...
(239, 'Kindeo', 'Kenn', 'Neikdo', '2025-09-17 23:01:02', '11111111111', 'test', '0', 'Kindeo', 'admin123', 'Admin', 'Active');
...
--
ALTER TABLE `tbl_appointment`
  MODIFY `appointment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=780;
...
--
ALTER TABLE `tbl_appointment_services`
  MODIFY `appointment_service_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=816;
...
--
ALTER TABLE `tbl_overhead`
  MODIFY `over_head_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_stylists`
  MODIFY `stylist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `tbl_subcategory`
  MODIFY `subCategory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
